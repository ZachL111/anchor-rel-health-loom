"""Regression checks for the anchor-rel-health-loom casebook."""
...
from casebook.harness import assert_expected, anchor_rel_health_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(anchor_rel_health_loom_summary(), assert_expected())
